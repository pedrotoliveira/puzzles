...
${OBJECTDIR}/projecteuler/problem_2.o: projecteuler/problem_2.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/projecteuler/problem_2.o projecteuler/problem_2.c

${OBJECTDIR}/projecteuler/problem_1.o: projecteuler/problem_1.c 
	${MKDIR} -p ${OBJECTDIR}/projecteuler
	${RM} $@.d
	$(COMPILE.c) -g -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/projecteuler/problem_1.o projecteuler/problem_1.c

${OBJECTDIR}/projecteuler/main.o: projecteuler/main.c 
	${MKDIR} -p ${OBJECTDIR}/projecteuler
	${RM} $@.d
	$(COMPILE.c) -g -I. -MMD -MP -MF $@.d -o ${OBJECTDIR}/projecteuler/main.o projecteuler/main.c
